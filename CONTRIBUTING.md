# Contributing to ml-snippeting

ml-snippeting welcomes new contributors. This document will guide you
through the process.
...
If you have questions about how to use ml-snippeting, check our documentation on the [Wiki][wiki]. Alternatively, check [Stack Overflow][mlstack] to see if it has been answered there, and post your question there if not. Please tag it with MarkLogic, and AngularJS.
...
* **ml-snippeting Version** - is it a named version or from our master branch
...
Fork the project [on GitHub](https://github.com/grtjn/ml-snippeting/fork) and clone
your copy.

```sh
$ git clone git@github.com:username/ml-snippeting.git
$ cd ml-snippeting
$ git remote add upstream git://github.com/grtjn/ml-snippeting.git
```
...
Go to https://github.com/username/ml-snippeting and select your feature branch. Click
...
[wiki]: https://github.com/grtjn/ml-snippeting/wiki
[mlstack]: http://stackoverflow.com/questions/tagged/marklogic
[issue tracker]: https://github.com/grtjn/ml-snippeting/issues
